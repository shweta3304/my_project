...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_banana_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_banana_t qt_meta_stringdata_banana = {
    {
QT_MOC_LITERAL(0, 6) // "banana"
...
const QMetaObject banana::staticMetaObject = { {
    QMetaObject::SuperData::link<orange::staticMetaObject>(),
    qt_meta_stringdata_banana.offsetsAndSize,
    qt_meta_data_banana,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_banana_t
, QtPrivate::TypeAndForceComplete<banana, std::true_type>
...
void *banana::qt_metacast(const char *_clname)
{
    ...
    return orange::qt_metacast(_clname);
}

int banana::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = orange::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
